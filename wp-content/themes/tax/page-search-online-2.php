...
<head>
    ...
    <meta name="description" content="<?= str_replace("\"", "'", get_field('search_online_world_page_description_meta')); ?>">
    <meta name="keywords" content="<?= str_replace("\"", "'", get_field('search_online_world_page_keywords')); ?>">
