            ...
            <div class="blog">
                ...
                <div class="social-block wow fadeInUp" data-wow-duration="1s">
                    ...
                    <div class="share">
                        ...
                        <div class="link">
                            <a class="fb-share"
                               href="https://www.facebook.com/sharer/sharer.php?u=<?= get_permalink($post->ID); ?>&title=<?= str_replace("\"", "'", get_the_title($post->ID)); ?>&p[summary]=<?= str_replace("\"", "'", get_field('news_page_description_meta')); ?>"><i
                                    class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a class="fb-share"
                               href="https://plus.google.com/share?url=<?= get_permalink($post->ID); ?>"><i
                                    class="fa fa-google-plus" aria-hidden="true"></i></a>
                            <a class="fb-share"
                               href="http://twitter.com/share?text=<?= str_replace("\"", "'", get_the_title($post->ID)); ?>&url=<?= get_permalink($post->ID); ?>"><i
                                    class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a class="fb-share"
                               href="http://vk.com/share.php?url=<?= get_permalink($post->ID); ?>&title=<?= str_replace("\"", "'", get_the_title($post->ID)); ?>&description=<?= str_replace("\"", "'", get_field('news_page_description_meta')); ?>&image=<?php if (get_field('news_image')) {
                                   the_field('news_image');
                               } else {
                                   the_field('header_logo_1', 'option');
